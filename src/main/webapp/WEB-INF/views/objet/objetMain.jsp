  ...
  <div class="container1">
     <div class="container">
      ...
      <div class="thecard">
         ...
         <img id="cardimg" src="resources/images/main/YU.jpg" width=30%>
            <div class ="writername">유노유진</div><br>
            <div class ="writercoment">작가 한줄 소개</div>
   <div class="tagboxes">
   <div class="tagbox1">태그다</div>
   <div class="tagbox2">태그</div>
   <div class="tagbox3">태그</div> 
   </div>
         </div>
         <div class="theback">
   ...
   <div class="container1">
     <div class="container">
      ...
      <div class="thecard">
         <div class="thefront"><br>
         <img id="cardimg" src="resources/images/main/KS.jpg" width=30%>
   ...
   <div class="container1">
     <div class="container">
      ...
      <div class="thecard">
         <div class="thefront"><br>
         <img id= "cardimg" src="resources/images/main/YY.jpg" width=30%>
            <p><i class="fas fa-user-circle"></i></p>
   ...
   <div class="container1">
     <div class="container">
      ...
      <div class="thecard">
         <div class="thefront"><br>
         <img id= "cardimg" src="resources/images/main/MY.jpg" width=50%>
            <p><i class="fas fa-user-circle"></i></p>
   ...
   <div class="container1">
     ...
     <div class="container">
      ...
      <div class="thecard">
         <div class="thefront"><br>
         <img  id= "cardimg" src="resources/images/main/ES.jpg" width=50%>
            <p><i class="fas fa-user-circle"></i></p>
