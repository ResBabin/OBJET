...
<!-- 제작용 css -->
 ...
 $(function(){
	...
	//포트폴리오 글 입력 후 DB 저장시 적용
	 var str2 = $('#userintrol').val();
	 str2 = str2.replace(/(?:\r\n|\r|\n)/g, '<br/>');
	 $('#userintrol').val(str2);
	
	 //포트폴리오 DB에서 불러와 textarea로 수정 시 <br>이 그대로 노출되는 것을 방지
	 var str2 = $('.#userintrol').val();
...
<br><br>
	...
	<p class="artistIntroContent2">
		<!-- 페이스북 --><div class="artistURL"><i class="facebook f icon"></i></div><div class="ui input" style="width: 500px;">
			<input type="text" name="facebook" id="facebook" value="" placeholder="페이스북 계정"></div><br><br>
		
	 	<!-- 인스타그램 --><div class="artistURL"><i class="instagram icon"></i></div><div class="ui input" style="width: 500px;">
	 		<input type="text" name="instagram" id="instagram" value="" placeholder="인스타그램 계정"></div><br><br>
		
	 	<!-- 기타URL --><div class="artistURL"><i class="linkify icon"></i></div><div class="ui input" style="width: 500px;">
	 		<input type="text" name="etcurl" id="etcurl" value="" placeholder="기타 URL"></div><br><br>
		
	 	<!-- 이메일 --><div class="artistURL"><i class="envelope outline icon"></i></div><div class="ui input" style="width: 500px;">
	 		<input type="text" name="artistemail" id="artistemail" value="" placeholder="작가 이메일"></div>
  	</p>
	<br><br><br>
	<div align="center">
