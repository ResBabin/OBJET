...
@Component
public class ObjetManagement implements Serializable{
	...
	public ObjetManagement() {}

	public ObjetManagement(int objetno, String userid, String username, String nickname, String objettitle,
			String objetintro, String originmainposter, String renamemainposter, Date objetstartdate, Date objetenddate,
			String objettag, String publicyn, Date objetregidate, String objetstatus, int objetview, String objettitle1,
	...
	public String toString() {
		return "ObjetManagement [objetno=" + objetno + ", userid=" + userid + ", username=" + username + ", nickname="
				+ nickname + ", objettitle=" + objettitle + ", objetintro=" + objetintro + ", originmainposter="
				+ originmainposter + ", renamemainposter=" + renamemainposter + ", objetstartdate=" + objetstartdate
				+ ", objetenddate=" + objetenddate + ", objettag=" + objettag + ", publicyn=" + publicyn
				+ ", objetregidate=" + objetregidate + ", objetstatus=" + objetstatus + ", objetview=" + objetview
				+ ", objettitle1=" + objettitle1 + ", objetintro1=" + objetintro1 + ", objetofile1=" + objetofile1
				+ ", objetrfile1=" + objetrfile1 + ", objettitle2=" + objettitle2 + ", objetintro2=" + objetintro2
				+ ", objetofile2=" + objetofile2 + ", objetrfile2=" + objetrfile2 + ", objettitle3=" + objettitle3
				+ ", objetintro3=" + objetintro3 + ", objetofile3=" + objetofile3 + ", objetrfile3=" + objetrfile3
				+ ", objettitle4=" + objettitle4 + ", objetintro4=" + objetintro4 + ", objetofile4=" + objetofile4
				+ ", objetrfile4=" + objetrfile4 + ", objettitle5=" + objettitle5 + ", objetintro5=" + objetintro5
				+ ", objetofile5=" + objetofile5 + ", objetrfile5=" + objetrfile5 + ", objettitle6=" + objettitle6
				+ ", objetintro6=" + objetintro6 + ", objetofile6=" + objetofile6 + ", objetrfile6=" + objetrfile6
				+ ", objettitle7=" + objettitle7 + ", objetintro7=" + objetintro7 + ", objetofile7=" + objetofile7
				+ ", objetrfile7=" + objetrfile7 + ", objettitle8=" + objettitle8 + ", objetintro8=" + objetintro8
				+ ", objetofile8=" + objetofile8 + ", objetrfile8=" + objetrfile8 + "]";
	}
