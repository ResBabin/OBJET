...
public class Objet3 implements Serializable{
	
	private static final long serialVersionUID = -7125177198381514840L;
	...
	public Objet3(int objetno, String userid, String objettitle, String objetintro, String originmainposter, String renamemainposter, Date objetstartdate, Date objetenddate,
			String objettag, String publicyn, Date objetregidate, String objetstatus, int objetview, String objettitle1, String objetintro1, String objetofile1, String objetrfile1,
			String objettitle2, String objetintro2, String objetofile2, String objetrfile2, String objettitle3, String objetintro3,
			String objetofile3, String objetrfile3, String objettitle4, String objetintro4, String objetofile4, String objetrfile4,
			String objettitle5, String objetintro5, String objetofile5, String objetrfile5, String objettitle6, String objetintro6,
			String objetofile6, String objetrfile6, String objettitle7, String objetintro7, String objetofile7, String objetrfile7,
			String objettitle8, String objetintro8, String objetofile8, String objetrfile8) {
		super();
	...
	public String toString() {
		return "Objet3 [objetno=" + objetno + "userid=" + userid + "objettitle=" + objettitle + ", objetintro=" + objetintro + ", originmainposter="
				+ originmainposter + ", renamemainposter=" + renamemainposter + ", objetstartdate=" + objetstartdate
				+ ", objetenddate=" + objetenddate + ", objettag=" + objettag + ", publicyn=" + publicyn + ", objetregidate=" + objetregidate 
				+ ", objetstatus=" + objetstatus + ", objetview=" + objetview + ", objettitle1=" + objettitle1
				+ ", objetintro1=" + objetintro1 + ", objetofile1=" + objetofile1 + ", objetrfile1=" + objetrfile1 + ", objettitle2=" + objettitle2 
				+ ", objetintro2=" + objetintro2 + ", objetofile2=" + objetofile2 + ", objetrfile2=" + objetrfile2 + ", objettitle3=" + objettitle3 
				+ ", objetintro3=" + objetintro3 + ", objetofile3=" + objetofile3 + ", objetrfile3=" + objetrfile3 + ", objettitle4=" + objettitle4
				+ ", objetintro4=" + objetintro4 + ", objetofile4=" + objetofile4 + ", objetrfile4=" + objetrfile4 + ", objettitle5=" + objettitle5 
				+ ", objetintro5=" + objetintro5 + ", objetofile5=" + objetofile5 + ", objetrfile5=" + objetrfile5 + ", objettitle6=" + objettitle6 
				+ ", objetintro6=" + objetintro6 + ", objetofile6=" + objetofile6 + ", objetrfile6=" + objetrfile6 + ", objettitle7=" + objettitle7
				+ ", objetintro7=" + objetintro7 + ", objetofile7=" + objetofile7 + ", objetrfile7=" + objetrfile7 + ", objettitle8=" + objettitle8 
