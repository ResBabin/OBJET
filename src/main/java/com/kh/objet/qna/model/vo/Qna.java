...
public class Qna implements Serializable{
   ...
   public Qna(int qnano, String userid, String adminid, String qnatype, String qnatitle, String qnacontent,
         Date questiondate, String qnaanswer, Date answerdate, String qnaofile, String qnarfile,
         char qnaanswertype) {
      super();
      this.qnano = qnano;
      this.userid = userid;
   ...
   public char getQnaanswertype() {
      return qnaanswertype;
   }


   public void setQnaanswertype(char qnaanswertype) {
      this.qnaanswertype = qnaanswertype;
   }
