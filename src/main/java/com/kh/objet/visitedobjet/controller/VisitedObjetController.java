...
public class VisitedObjetController {
	...
	// 오브제 관리 - 다녀온 오브제 페이지 이동
		...
		public String moveMyVisitedObjetList(@RequestParam(name="page", required=false) String page, Model model) {
	...
	//오브제 관리 - 다녀온 오브제 삭제
			...
			public String deleteMyVisitedObjetList(@RequestParam(value="objetno", required=false) int objetno, HttpServletResponse response) throws IOException {
	...
	//오브제 관리 - 다녀온 오브제 검색
		...
		public String selectMyVisitedObjetSearch(@RequestParam(name="page", required=false) String page, @RequestParam(value="objettitle", required=false) String objettitle, 
				@RequestParam(value="userid", required=false) String userid, @RequestParam(value="objetstatus", required=false) String objetstatus, Model model) {
			logger.info("page : " + page);
		    int currentPage = 1;
		    if(page !=null) {
		       currentPage = Integer.parseInt(page);
		    ...
		    //페이징
	            ...
	            List<VisitedObjet> list = visitedObjetService.selectMyVisitedObjetSearch(map);
